...
class MocapComparer:
        def __init__(self):
            ...
            rospy.loginfo(f"Logging comparison data to: {self.log_file_path}")
        ...
        def data_callback(self, amcl_msg, mocap_msg):
            ...
            # Calculate error
            error_x = amcl_pose.position.x - mocap_pose.position.x
            error_y = amcl_pose.position.y - mocap_pose.position.y
